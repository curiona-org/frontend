  ...
  return (
    <div className="w-full">
      <div className="relative w-full">
        <NeonGradientCard className="flex-grow w-full h-full text-mobile-heading-4-regular md:text-heading-4-regular text-gray-700 bg-gradient-to-br from-[#ff2975] to-[#00fff1] relative">
          <input
            type="text"
            maxLength={150}
            placeholder="Type here to generate your roadmap"
            className={`w-full max-h-[83px] focus:outline-none bg-inherit ${
