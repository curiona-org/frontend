  ...
  return (
    <div className="w-full">
      <div className="relative w-full">
        <NeonGradientCard className="flex-grow w-full h-full text-mobile-heading-4-regular lg:text-heading-4-regular bg-gradient-to-br from-[#ff2975] to-[#00fff1] relative">
          <input
            type="text"
            maxLength={150}
            placeholder="Type here to generate your roadmap"
            className={`w-full h-full px-5 rounded-[var(--card-content-radius)] focus:outline-none bg-inherit ${
          ...
          <button
            ...
            className="absolute right-3 top-1/2 -translate-y-1/2 rounded-lg bg-blue-500 p-3 text-white hover:bg-blue-900 focus:outline-none transition-transform duration-300 ease-out hover:scale-105 active:scale-95"
          >
            <svg
