          ...
          <div className="dashedBorder2 flex flex-col gap-6 p-6 bg-white-100 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg lg:max-w-md">
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              ...
              <div className="flex flex-col gap-2">
                <button
                  type="submit"
                  className="w-full px-4 py-2 text-white-500 bg-blue-500 hover:bg-blue-900 rounded-md focus:outline-none focus:ring focus:ring-blue-900 transition-all duration-300 ease-out hover:scale-105 focus:scale-100"
                >
