  ...
  return (
    <div className="w-full">
      <div className="relative">
        <div className="flex-grow w-full h-16 text-mobile-heading-4-regular lg:text-heading-4-regular rounded-lg bg-white-500 border border-gray-300 shadow shadow-blue-500">
          <ShineBorder borderWidth={2} shineColor={["#4b7ce8", "#5C469C"]} />
          <input
            type="text"
            maxLength={150}
