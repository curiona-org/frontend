  ...
  return (
    <>
      ...
      <div className="flex items-center justify-center min-h-screen px-6 py-28 ">
        <div className="dashedBorder1">
          <div className="dashedBorder2 flex flex-col gap-6 p-6 bg-white-100 rounded-lg shadow-lg w-full max-w-md sm:max-w-lg lg:max-w-md">
            ...
            <form className="space-y-4" onSubmit={onSubmit}>
              ...
              <div className="flex flex-col gap-2">
                ...
                <button
                  ...
                  type="button"
                  className="flex gap-1 items-center justify-center w-full px-4 py-2 text-black-500 outline outline-blue-500 rounded-md focus:outline-none hover:bg-blue-900 hover:outline-none hover:text-white-500 focus:ring focus:ring-blue-900"
                >
                  <svg
